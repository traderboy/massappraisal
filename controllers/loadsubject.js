		  ...
		  */
		  var sql=
			  [
			   	...
			   	,"insert into "+req.user.shortName+".tables(name,type,geometrytype,filetype,date_loaded) values('"+baseTableName+"',0,'"+(req.query.stype?req.query.stype.replace(/\W/g, ''):"Multipolygon")+"','" + (req.query.type?req.query.type.replace(/\W/g, '').replace(/ESRI/g,"ESRI "):"Unknown") + "',NOW())",
